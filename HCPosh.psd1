...
@{
	...
	RequiredAssemblies = @('libraries\Newtonsoft.Json.dll', 'libraries\Catalyst.Data.dll', 'libraries\ColumnExtractor.dll', 'libraries\Microsoft.SqlServer.TransactSql.ScriptDom.dll', 'libraries\System.IO.Compression.FileSystem.dll')
