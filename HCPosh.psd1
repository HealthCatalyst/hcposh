...
@{
	...
	RequiredAssemblies = @('libraries\ColumnExtractor.dll', 'libraries\Microsoft.SqlServer.TransactSql.ScriptDom.dll', 'libraries\System.IO.Compression.FileSystem.dll')
